        ...
        <div id="kt_content_container" class="container-xxl">
            ...
            <div class="card mb-5 mb-xl-8 shadow-sm">
                ...
                <div class="card-header border-0 pt-5 d-flex justify-content-between align-items-center">
                    <h3 class="card-title fw-bolder fs-3 mb-0">Daftar Jabatan</h3>
                                    ...
                                    <td class="text-end">
                                        <div class="d-flex justify-content-end flex-shrink-0">
                                            ...
                                            <a href="#"
                                                ...
                                                data-id="{{ $j->id_jabatan }}" data-nama="{{ $j->nama_jabatan }}">
                                                <span class="svg-icon svg-icon-3">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                        viewBox="0 0 24 24" fill="none">
                                                        <path opacity="0.3"
                                            ...
                                            <a href="javascript:void(0)"
                                                ...
                                                onclick="confirmDelete({{ $j->id_jabatan }})">
                                                <span class="svg-icon svg-icon-3">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                        viewBox="0 0 24 24" fill="none">
                                                        <path
                ...
                <div class="modal-dialog modal-dialog-centered mw-650px">
                    ...
                    <div class="modal-content rounded">
                        ...
                        <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                            <!--begin:Form-->
                            <form id="kt_modal_new_target_form" class="form" action="{{ route('jabatan.store') }}"
                                method="POST" enctype="multipart/form-data">
                                @csrf

                                <!--begin::Heading-->
                                <div class="mb-13 text-center">
                                    <h1 class="mb-3">Tambah Data Jabatan</h1>
                    ...
                    <div class="modal-content rounded">
                        ...
                        <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                            <form id="kt_modal_edit_form" class="form" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="mb-13 text-center">
                                    <h1 class="mb-3">Edit Data Jabatan</h1>
                                    <div class="text-muted fw-bold fs-5">
                                        Perbarui data jabatan sesuai kebutuhan
                                    </div>
                                </div>
                                ...
                                <div class="d-flex flex-column mb-8 fv-row">
                                    ...
                                    <input type="text" class="form-control form-control-solid" name="nama_jabatan"
                                        id="edit_nama_jabatan" required />
                                </div>
                                <!-- Tombol -->
                                <div class="text-center">
...
<script>
    ...
    editModal.addEventListener('show.bs.modal', function(event) {
        ...
        // Fill form fields
        document.getElementById('edit_nama_jabatan').value = button.getAttribute('data-nama');
